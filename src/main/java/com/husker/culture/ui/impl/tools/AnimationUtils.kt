...
import com.husker.culture.ui.core.animation.easing.Back
import com.husker.culture.ui.core.animation.easing.Easing
...
class AnimationUtils {
    ...
    companion object {
        ...
        private fun bindAnimatedField(node : Node, oldProperty : DoubleProperty, field : String, easing : Easing, duration : Int){
            ...
            layout[node] = object : DoublePropertyBase(oldProperty.get()){
